...
if($keysearch){
	$query = array('$or' => array(
        array('kyhieu' => array('$regex' => '^'.$keysearch, '$options' => 'i')),
        array('maminhchung' =>array('$regex' => '^'.$keysearch, '$options' => 'i')),
        array('ten' => array('$regex' => '^'.$keysearch, '$options' => 'i')),
		array('noiphathanh' => array('$regex' => '^'.$keysearch, '$options' => 'i')),
		array('sovanban' => array('$regex' => '^'.$keysearch, '$options' => 'i')),
		array('sovanbanden' => array('$regex' => '^'.$keysearch, '$options' => 'i')),
		array('nguoiky' => array('$regex' => '^'.$keysearch, '$options' => 'i')),
		array('noidung' => array('$regex' => '^'.$keysearch, '$options' => 'i')),
	));
